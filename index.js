...
/***/ function(module, exports, __webpack_require__) {
	...
	var config = {
	    ...
	    colorVary: true,
	    ctx: html_ts_1["default"].canvas.getContext('2d'),
	    ctxP: html_ts_1["default"].preview.getContext('2d'),
	    scale: enums_ts_1.scaleSize.Medium,
	    showGrid: false,
	    size: enums_ts_1.tileSize.Medium
	};
	var mouse = {
	    x: 0,
	    y: 0
	};
	var sprite = new Sprite_ts_1["default"](html_ts_1["default"].canvas, config);
	function resetCanvas() {
	    html_ts_1["default"].canvas.width = config.size * config.scale;
	    html_ts_1["default"].canvas.height = config.size * config.scale;
	    html_ts_1["default"].preview.width = config.size * 3;
	    html_ts_1["default"].preview.height = config.size * 3;
	}
	resetCanvas();
	...
	options.push({
	    ...
	    template: templates_ts_1["default"].checkbox,
	    selected: '',
	    cb: function () {
	...
	options.push({
	    id: 'pixel-scale',
	    title: 'Pixel Scale',
	    template: templates_ts_1["default"].dropdown,
	    selected: enums_ts_1.scaleSize.Medium.toString(),
	    options: [
	        {
	            value: enums_ts_1.scaleSize.Original.toString(),
	            label: 'Original'
	        },
	        {
	            value: enums_ts_1.scaleSize.Small.toString(),
	            label: 'Small (' + enums_ts_1.scaleSize.Small + ')'
	        },
	        {
	            value: enums_ts_1.scaleSize.Medium.toString(),
	            label: 'Medium (' + enums_ts_1.scaleSize.Medium + ')'
	        },
	        {
	            value: enums_ts_1.scaleSize.Large.toString(),
	            label: 'Large (' + enums_ts_1.scaleSize.Large + ')'
	        }
	    ],
	    cb: function (value) {
	        config.scale = value;
	...
	options.push({
	    ...
	    title: 'Sprite Size',
	    template: templates_ts_1["default"].dropdown,
	    selected: enums_ts_1.tileSize.Medium.toString(),
	    options: [
	        {
	            value: enums_ts_1.tileSize.Small.toString(),
	            label: 'Small (' + enums_ts_1.tileSize.Small + 'x' + enums_ts_1.tileSize.Small + ')'
	        },
	        {
	            value: enums_ts_1.tileSize.Medium.toString(),
	            label: 'Medium (' + enums_ts_1.tileSize.Medium + 'x' + enums_ts_1.tileSize.Medium + ')'
	        },
	        {
	            value: enums_ts_1.tileSize.Large.toString(),
	            label: 'Large (' + enums_ts_1.tileSize.Large + 'x' + enums_ts_1.tileSize.Large + ')'
	        },
	    ],
	    cb: function (value) {
	        config.size = value;
	...
	options.forEach(function (option) {
	    ...
	    html_ts_1["default"].toolbar.appendChild(div);
	...
	newOption.onclick = function () {
	    sprite = new Sprite_ts_1["default"](html_ts_1["default"].canvas, config);
	};
	html_ts_1["default"].toolbar.appendChild(newOption);
	var saveOption = document.createElement('button');
	saveOption.id = 'option-save';
	saveOption.innerHTML = 'Download';
	saveOption.onclick = function () {
	    html_ts_1["default"].preview.width = config.size;
	    html_ts_1["default"].preview.height = config.size;
	    sprite.preview(true);
	    var image = html_ts_1["default"].preview.toDataURL('image/png').replace('image/png', 'image/octet-stream');
	    location.href = image;
	    html_ts_1["default"].preview.width = config.size * 3;
	    html_ts_1["default"].preview.height = config.size * 3;
	};
	html_ts_1["default"].toolbar.appendChild(saveOption);
	var link = document.createElement('p');
	link.innerHTML = '<a href="https://github.com/deificx/sprite">project on github</a>';
	html_ts_1["default"].toolbar.appendChild(link);
	...
	function update() {
	    ...
	    config.ctx.clearRect(0, 0, html_ts_1["default"].canvas.width, html_ts_1["default"].canvas.height);
	    config.ctxP.clearRect(0, 0, html_ts_1["default"].preview.width, html_ts_1["default"].preview.height);
	    sprite.preview(false);
	    sprite.render();
	    if (config.showGrid && config.scale != enums_ts_1.scaleSize.Original) {
	        sprite.grid();
	    }
	    renderBrush();
	}
